...
from keras.layers import Embedding, SimpleRNN, Conv1D, MaxPooling1D
...
#print(avg(history.history['acc']))

##############################      Save the Trained Model      #############################
#model_json = model.to_json()
#open('RNNTrg.json','w').write(model_json)
#model.save_weights('RNNweights.h5', overwrite=True)
